...
[![Build Status](https://img.shields.io/travis/nsivanoly/LaravelFacebookSdk.svg)](https://travis-ci.org/nsivanoly/LaravelFacebookSdk)
[![Latest Stable Version](https://img.shields.io/packagist/v/nsivanoly/laravel-facebook-sdk.svg?maxAge=2592000)](https://packagist.org/packages/nsivanoly/laravel-facebook-sdk)
[![Total Downloads](https://img.shields.io/packagist/dt/nsivanoly/laravel-facebook-sdk.svg)](https://packagist.org/packages/nsivanoly/laravel-facebook-sdk)
[![License](https://img.shields.io/badge/license-MIT-lightgrey.svg)](https://github.com/nsivanoly/LaravelFacebookSdk/blob/master/LICENSE)
...
Add the Laravel Facebook SDK package to your `composer.json` file.
    ...
    composer require nsivanoly/laravel-facebook-sdk
...
```php
$app->register(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdkServiceProvider::class);
```
...
```php
'aliases' => [
    'Facebook' => Nsivanoly\LaravelFacebookSdk\FacebookFacade::class,
    ];
```
...
$fb = App::make('Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk');
// Or in PHP >= 5.5
$fb = app(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk::class);

// From a constructor
class FooClass {
    public function __construct(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk $fb) {
       // . . .
    }
}
...
// From a method
class BarClass {
    public function barMethod(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk $fb) {
       // . . .
    }
}

// Or even a closure
Route::get('/facebook/login', function(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk $fb) {
    // . . .
});
```
...
```bash
$ php artisan vendor:publish --provider="Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdkServiceProvider" --tag="config"
```
...
This example also demonstrates how to [exchange a short-lived access token with a long-lived access token](https://www.nsivanoly.me/access-token-handling-best-practices-in-facebook-php-sdk-v4) and save the user to your `users` table if the entry doesn't exist.
...
Route::get('/facebook/callback', function(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk $fb)
{
...
```php
Route::get('/facebook/javascript', function(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk $fb) {
    try {
...
```php
Route::match(['get', 'post'], '/facebook/canvas', function(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk $fb) {
    try {
...
```php
Route::match(['get', 'post'], '/facebook/page-tab', function(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk $fb) {
    try {
...
class FacebookController {
    public function getUserInfo(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk $fb) {
       try {
           $response = $fb->get('/me?fields=id,name,email');
       } catch (Facebook\Exceptions\FacebookSDKException $e) {
           dd($e->getMessage());
...
```php
Route::get('/example', function(Nsivanoly\LaravelFacebookSdk\LaravelFacebookSdk $fb) {
...
Please see [CONTRIBUTING](https://github.com/nsivanoly/LaravelFacebookSdk/blob/master/CONTRIBUTING.md) for details.


## Credits

This package is maintained by [Scott Bowler](https://github.com/nsivanoly). See a [full list of contributors](https://github.com/nsivanoly/laravel-facebook-sdk/contributors).


## License

The MIT License (MIT). Please see [License File](https://github.com/nsivanoly/LaravelFacebookSdk/blob/master/LICENSE) for more information.
